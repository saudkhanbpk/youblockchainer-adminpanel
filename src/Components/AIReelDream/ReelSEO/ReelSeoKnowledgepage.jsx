...
import { getKnowledgePageSEO, updateKnowledgePageSEO } from "../../../api/api";

const ReelSeoKnowledgepage = () => {
  ...
  const onUpdatePage = async (e) => {
    ...
    await updateKnowledgePageSEO(idState, formdata);
    alert(`Updated!`);
  };
...
export default ReelSeoKnowledgepage;
