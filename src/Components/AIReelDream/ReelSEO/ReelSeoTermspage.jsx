...
import { getTermsPageSEO, updateTermsPageSEO } from "../../../api/api";

const ReelSeoTermspage = () => {
  ...
  const onUpdatePage = async (e) => {
    ...
    await updateTermsPageSEO(idState, formdata);
    alert(`Updated!`);
  };
  ...
  return (
    <>
      <Fragment>
        <Breadcrumbs
          parent="Terms & Conditions Page"
          title="Terms & Conditions Page"
          mainTitle="Terms & Conditions Page"
        />
...
export default ReelSeoTermspage;
